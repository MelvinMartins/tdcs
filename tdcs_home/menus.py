""" Menu configuration for tdcs. The following menus are displayed:
...
from tdcs.settings import CURATE_MENU_NAME
from tdcs.settings import GPS_VISUALIZATION_MENU_NAME
...
Menu.add_item("nodropdown", MenuItem(GPS_VISUALIZATION_MENU_NAME, reverse("core_gps_visualization_index")))
