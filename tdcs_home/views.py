...
def template_list(request):
    ...
    return render(request, "tdcs_home/template_list.html", context)
...
def tiles(request):
    ...
    if "core_explore_example_app" in installed_apps:
        explore_example_tile = {
            ...
            "text": "Click here to search for Timing Data in the repository using flexible queries.",
        }
    ...
    if "core_explore_keyword_app" in installed_apps:
        explore_keywords_tile = {
            ...
            "text": "Click here to explore for Timing Data in the repository using keywords.",
        }
    ...
    return render(request, "tdcs_home/tiles.html", context)
